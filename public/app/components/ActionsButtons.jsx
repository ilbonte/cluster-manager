...
export default class ActionsButtons extends React.Component {
    ...
    render() {
        ...
        let runButton = <RunButton key={400} data={this.props.data} getData={this.props.getData}><Glyphicon glyph="send"/></RunButton>;
...
class RunButton extends React.Component {
    ...
    render() {
        ...
        return ( < Button bsStyle = "success" bsSize = {actionButtonSize} > <Glyphicon glyph="send" onClick={this.open}/ > < Modal show = {
            ...
            onHide = {
                ...
                {' '}
                <FormControl type="text" placeholder="name" size="8" onChange={this.handleFieldChange.bind(this, 'name')}/></Form>
            {                networkForm
            } < /Modal.Body > <Modal.Footer>
            <Button onClick={this.startInstance}>Start</Button > <Button onClick={this.close}>Close</Button> < /Modal.Footer> < /Modal > < /Button >)
    }
}
